...
ConnectorTimerEntry::ConnectorTimerEntry(std::shared_ptr<Connector> connector, EventLoop *ev_loop) {
...
void ConnectorTimeout::update_connector_time(std::shared_ptr<Connector> connector)
{
