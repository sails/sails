...
public:
    ...
    static std::string GetMD5(const BYTE* pBuf, UINT nLength);
    static bool GetTruncatedMD5(BYTE* pBuf, 
                                UINT nLength, 
...
protected:
    ...
    std::string  Final();
    bool Final(std::vector<BYTE>& vecOut, UINT iSize);
