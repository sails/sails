...
void HandleProtoDecode::do_handle(common::net::HttpRequest *request, 
...
void HandleProtoDecode::decode_protobuf(common::net::HttpRequest *request, common::net::HttpResponse *response, HandleChain<common::net::HttpRequest *, common::net::HttpResponse *> *chain)
{
