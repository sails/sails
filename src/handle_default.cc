...
void HandleDefault::do_handle(common::net::HttpRequest *request, 
			      ...
			      HandleChain<common::net::HttpRequest *, common::net::HttpResponse *> *chain)
{
	...
	printf("proto_type:%d\n", proto_type);
	if(proto_type != common::net::NORMAL_PROTOCOL) {
...
std::string HandleDefault::get_request_path(common::net::HttpRequest *request) {
